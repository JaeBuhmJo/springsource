...
<form action='<c:url value="/member/register"/>' method="post" novalidate>
	...
	<div class="mb-3">
		...
		<input type="password" class="form-control" id="password" name="password" placeholder="비밀번호" required pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[!@#$%])[A-Za-z\d!@#$%]{8,15}$">
	...
	<div class="mb-3">
		...
		<input type="radio" name="gender" id="gender-male" value="남" class="form-check-input" required />
		남
		<input type="radio" name="gender" id="gender-female" value="여" class="form-check-input" required />
		여
